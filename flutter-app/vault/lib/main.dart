...
class AppState extends State<App> {
  static const platform =
      const MethodChannel('com.ondralukes.vault/notification');
  String url;
  ServerAPI api;
    ...
    return MaterialApp(
        ...
        theme: ThemeData(
            ...
            textTheme: TextTheme(
                    ...
                    headline: TextStyle(color: Colors.grey, fontSize: 50))
                .apply(fontFamily: Platform.isIOS ? "Courier" : "monospace")),
